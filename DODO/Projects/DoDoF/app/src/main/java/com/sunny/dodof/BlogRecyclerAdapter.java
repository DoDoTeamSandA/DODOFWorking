...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder>  {
    ...
    @Override
    public void onBindViewHolder(@NonNull BlogRecyclerAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {

        final String blogPostId = blog_list.get(position).BlogPostId;
        final String fragk = fraglist.get(position).fragkey;
        final String PostUser=blog_list.get(position).user_id;
       ...
       final AlertDialog dialog= new SpotsDialog.Builder().setContext(context).build();
        ...
        holder.DeleteImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseFirestore.collection("Posts").document(CatKey).collection(Admin).document(blogPostId).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                       try {
                           blog_list.remove(position);
