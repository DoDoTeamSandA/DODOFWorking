...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        delete_btn=view.findViewById(R.id.DeletePost);
...
*/
            ...
            Query firstQuery = firebaseFirestore.collection("Posts").document("organic").collection(Current_User_Id).orderBy("timestamp", Query.Direction.DESCENDING);
